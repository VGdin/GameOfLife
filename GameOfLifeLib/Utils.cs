namespace GameOfLifeLib
{
    ...
    {
        private static readonly uint[] MortonTable256 =
        {
        ...
        /// <returns>Index that corespondce to the x,y coordinates</returns>
        public static ulong MortonNumber(uint x, uint y)
        {
            ulong z = MortonTable256[y >> 8] << 17 |
